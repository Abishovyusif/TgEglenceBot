C_LİST=[
	"Hər hansı bir sosyal medya hesabında ən çirkin şəklini paylaş😂.","Whatsappa girin gözünüzü yumun və rastgələ bir şəxsƏ NAZADI DANIŞAN yazın.",
	"Qoyun kimi mələyərək qrupa səs at🤣🐑",
	"5 dəqiqə boyunca qrupda 1 nəfərin köləsi ol nə istəsə yerinə yetir.","Telegram hesabını oyunçulardan birinə ver. Oyunçu 5 dəqiqə sənin hesabına baxa bilər.",
	"Qrupdan bir qıza Səni Sevirəm yaz ss at","5 dəqiqə Talış Ləhcəsində danış.",
	"Uşaq kimi inqə deyərək qrupa səs at!","Telefonunda ki ən sevmədiyin şəkili qrupa at","En beyəndiyin şəkli qrupa at",
	"Whatsapp’da son mesajını qrupa at","Ekran şəklini ss et qrupa at","Qalereyanı ss elə qrupa at",
	"20 dəfə mən malam de səs yaz qrupa at","Telegramda şəxsidəki son mesajı ss at.","Biona mən gicəm yaz; oyun bitənə qədər qalmalıdır.!",
	"Telegram profilinə Bayram Nurlunun şəklini qoy","Galereyandakı 15ci şəkli qrupa at.","Telegramda tanımadığın birinə Mən gicəm de.",
	"Laylay oxuyaraq qrupa səs at","Qrupa 10 nəfər at.","Grupda xətrini istədiyin adama səndən zəhləm gedir de.",
	"Galereyandakı 5ci şəkli at.","Galereyandakı 3cü şəkli at.","Whatsapp’da statusa mən malam yaz ss at",
	"Grupun üzvlər siyahısına gir ucı adama sən gicsən de. (Grup daha az kişiyse ya da aktif sayısı azsa üstten saymaya devam et)",
	"Telegramda ən son danışdığın adama \"Xiyar necəsən\" deyə mesaj at",
	"Hal hazırda olduğun yeri videoya çək qrupa at","Grupda üzvlər yerinə gir 11.ci adama \"Analar neler doğuruyor bee\" diyə səs at.",
